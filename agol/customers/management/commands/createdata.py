...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        #     registration = fake.license_plate()
        #     trailer = Vehicle.objects.get(pk=random.randint(0, 200))
        #     CustomerTrailer.objects.create(registration=registration, customer=customer, trailer=trailer)

        # for _ in range(30):
        #     customer = Customer.objects.get(pk=1)
        #     registration = fake.license_plate()
        #     truck = Vehicle.objects.get(pk=random.randint(200, 300))
        ...
        #     driver = Driver.objects.get(id=random.randint(1, 300))
        #     truck = Vehicle.objects.get(id=random.randint(1, 300))
        #     trailer = Vehicle.objects.get(id=random.randint(1, 300))  
